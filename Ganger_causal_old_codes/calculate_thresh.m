...
matfiles=[matfiles;dir('/home/shruti/Desktop/Himadri/Shruti/IITG-final-work/Young-Controls/*_SC.mat')];
k=0;
ran_net=zeros(50,68,68);
for i=0.01:0.01:0.5
    k=k+1;
   for j=1:length(matfiles)  
    name=strcat('/home/shruti/Desktop/Himadri/Shruti/IITG-final-work/Young-Controls/',matfiles(j).name);
